...
- [x] PHP Version 5.6, 7.0, 7.1, 7.3, 7.4, 8.0, 8.1
- [x] MariaDB Version 10.5.16
- [x] Apache 2 Server

# Getestete Shop Systeme
...
- ab 499,-€
- Keinerlei Informationen über Importmöglichkeiten

### Sylius

- Setzt auf Symfony (läuft bei uns auf dem Server nicht.)

### Smart Store

- Community Version verfügbar. Nicht DSGVO-Konform, muss stark angepasst werden.
- Import nur mit Plugin möglich
- Ab Premium Version ist DSGVO-Konform
- Ab Premium ist ein Medien Manager dabei.
- Keine Preise einsehbar.

### Oxid eSales

- Kostenpflichtiger Shop
- Kostenpflichtige Plugins
- Keine Informationen über Import (möglicherweise mit Plugin)
...
- für unsere Zwecke mindestens Professional Paket (189€ / Monat)
- Excel Import für Artikel möglich

### Peppershop

- Hosting nicht in der EU (Schweiz)
- Maximal 5GB Speicher (Wir belegen aktuell >30GB nur für Bilder...)

### Plentymarkts

- Aus Kassel
- Cloud Basierend
- Verdienen am Shop mit
- Keine Info über Import Möglichkeiten
- 42 - 1250€ / Monat

### Shopcloud.io

- Kompletter Service, alles direkt nach Kundenwunsch erstellt und konfiguriert.
- Keinerlei Preise einsehbar.

### Shopfactory

- Import aus externer Datenbank möglich.
- 95€ / Monat

### Versa Commerce

- Cloud Lösung
- Komplettes Commerce System mit Kasse etc.
- So gar nicht für uns geeignet.

### Webnode

- selbst im großen Paket (17,90€ / Monat) nur 7 GB Speicher.
